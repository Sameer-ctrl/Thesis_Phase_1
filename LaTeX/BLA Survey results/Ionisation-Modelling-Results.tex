...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.9\linewidth]{Ionisation-Modelling-Plots/pg1424-z=0.147104-compIII_logZ=-1_non_detection.png}
    \caption{N(\ion{H}{i})= 15.44, log $Z_{ref}$=-1}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{Ionisation-Modelling-Plots/pg1424-z=0.147104-compII_logZ=-1_non_detection.png}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.9\linewidth]{Ionisation-Modelling-Plots/pg1216-z=0.282286-compI_logZ=-1_non_detection.png}
    \caption{N(\ion{H}{i})=15.10, log $Z_{ref}$=-1}
\end{figure}

\begin{figure}[!b]
    \centering
    \includegraphics[width=0.9\linewidth]{Ionisation-Modelling-Plots/pg1216-z=0.282286-compII_logZ=-1_non_detection.png}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.9\linewidth]{Ionisation-Modelling-Plots/s135712-z=0.097869-compII_logZ=-1_non_detection.png}
    \caption{N(\ion{H}{i})=16.49, log $Z_{ref}$=-1}
\end{figure}

\begin{figure}[!b]
    \centering
    \includegraphics[width=0.9\linewidth]{Ionisation-Modelling-Plots/s135712-z=0.097869-compIII_logZ=1_non_detection.png}
    \caption{N(\ion{H}{i})=15.01, log $Z_{ref}$=1}
\end{figure}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.9\linewidth]{Ionisation-Modelling-Plots/1es1553-z=0.187764-compI_logZ=1_non_detection.png}
    \caption{N(\ion{H}{i})=12.76, log $Z_{ref}$=1}
\end{figure}

\begin{figure}[!b]
    \centering
    \includegraphics[width=0.9\linewidth]{Ionisation-Modelling-Plots/1es1553-z=0.187764-compII_logZ=-1_non_detection.png}
