...
Excluding \ion{O}{vi} : $n_H$ = -4.69 $\pm$ 0.07 \hspace{10mm} $Z$ = 1.19 $\pm$ 0.05

Including \ion{O}{vi} : $n_H$ = -4.65 $\pm$ 0.05 \hspace{10mm} $Z$ = 1.19 $\pm$ 0.05
\\\\
NOTE : Low N(\ion{H}{I}), and error for column density for \ion{C}{iii} and \ion{O}{vi} for component I were obtained from $\chi^2$, else they were large and convergence was not good. Nearly similar solution for both the cases. \\
