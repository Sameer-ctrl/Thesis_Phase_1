...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=9cm]{Figures/NHi_vs_bHi.png}
  \vspace*{-1mm}
...
\begin{frame}[noframenumbering]{\huge{{\textbf{Insights}}}}
  ...
  \begin{figure}[!htbp]
    \centering
    \includegraphics[width=9cm]{Figures/bHi_vs_BOvi.png}
    \vspace*{-1mm}
    \caption{\emph{b}(\ion{O}{vi}) vs. \emph{b}(\ion{H}{i})}
  \end{figure}
...
\uncover<1->{
  ...
  \vspace*{-1mm}
  \caption{Ionisation modelling solutions for both excluding and including \ion{O}{vi} cases.}
\end{figure}
}
...
\begin{figure}[!htbp]
  ...
  \vspace*{-1mm}
  \caption{$n_H$ vs. N(\ion{H}{i}) for both excluding and including \ion{O}{vi} cases.}
\end{figure}  
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=9cm]{Figures/NHi_vs_Z.png}
  \vspace*{-1mm}
  \caption{$Z$ vs. N(\ion{H}{i}) for both excluding and including \ion{O}{vi} cases.}
\end{figure}  
