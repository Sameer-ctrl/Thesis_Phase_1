...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=9cm]{Figures/placeholder.png}
  \vspace*{-1mm}
...
\uncover<1->{
  ...
  \includegraphics[width=9cm]{Figures/placeholder.png}
  \vspace*{-1mm}
  \caption{Distribution of no. of metal ions in the absorber systems}
\end{figure}
}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=12cm]{Figures/placeholder.png}
  \vspace*{-1mm}
  \caption{System plot of the absorber system towards LOS of }
\end{figure}  


\begin{tikzpicture}[remember picture, overlay,use page relative coordinates]
  
   \uncover<1->{\node at (0.05,0.92) {\LARGE{\textbf{I}}} ;}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=10cm]{Figures/placeholder.png}
  \vspace*{-1mm}
  \caption{Observed and predicted column densities of the ions.}
\end{figure}  
