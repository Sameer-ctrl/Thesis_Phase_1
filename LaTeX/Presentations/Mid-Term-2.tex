...
\begin{frame}[noframenumbering]{\textbf{Ex-1}}
...
\begin{frame}[noframenumbering]{\textbf{Ex-2}}
...
\begin{frame}[noframenumbering]{\textbf{Ex-3}}
...
\begin{frame}{\huge{{\textbf{Summary}}}}
  ...
  \uncover<1->{\begin{itemize}
    \item Voigt profile fitting : 22 absorbers -  Voigt profiles
