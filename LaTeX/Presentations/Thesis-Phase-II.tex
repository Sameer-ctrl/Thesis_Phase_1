...
\begin{columns}
    \begin{column}{0.5\textwidth} 
        ...
        \uncover<1->{
          \begin{itemize}
              ...
              \item BLA survey : 28 BLA candidates 
        \end{itemize}
        }
    \end{column}      
    ...
    \begin{tikzpicture}[remember picture, overlay,use page relative coordinates]
      ...
      \uncover<1->{\node at (0.20,0.17) {Ref. : Shull et al. (2012)} ;}
    ...
    \begin{column}{0.5\textwidth}
      \vspace*{-10mm}
        \uncover<1->{\begin{figure}[!htbp]
          \centering
          \hspace*{-7mm}
          \includegraphics[width=8cm]{Figures/PG0003+158-z=0.347579-sys-plot.png}
          \vspace*{-5.5mm}
          \caption{System plot of the absorber system towards PG 0003+158. Velocity is taken zero at z = 0.347579}
        \end{figure}}
    \end{column}
...
\begin{columns}
    \begin{column}{0.5\textwidth} 
        ...
        \uncover<1->{
          \begin{itemize}
              ...
              \item BLAs : Way to probe WHIM
              \item Absorber towards PG 0003+158
              \item \textbf{BLA survey : 28 BLA candidates} 
        \end{itemize}
        }
    \end{column}      
    ...
    \begin{column}{0.5\textwidth}
        \uncover<1->{\begin{figure}[!htbp]
          \centering
          \includegraphics[width=7cm]{Figures/metal-ions.png}
          \vspace*{-6mm}
          \caption{Distribution of metal ions in all 28 candidate BLAs}
        \end{figure}}
    \end{column}
...
\begin{tikzpicture}[remember picture, overlay,use page relative coordinates]
  ...
  \uncover<1->{\node at (0.20,0.17) {Ref. : Shull et al. (2012)} ;
  \node at (0.25,0.12) {Danforth et al. (2016)} ;}
...
\uncover<1->{  
\begin{itemize}
  \uncover<2->{\item Voigt profile fitting : 16 (\ion{O}{vi}) + \textbf{6}}
  \uncover<3->{\item Ionisation Modelling : \textbf{16 (\ion{O}{vi})}}
\end{itemize}
}
...
\begin{frame}{\huge{{\textbf{Insights}}}}

\begin{figure}[!htbp]
  \centering
  \includegraphics[width=10cm]{Figures/NHi_bHi_distribution.png}
  \vspace*{-1mm}
  \caption{Distribution of \ion{H}{i} column densities and Doppler parameters.}
\end{figure}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=9cm]{Figures/NHi_vs_bHi_danforth.png}
  \vspace*{-1mm}
  \caption{\ion{H}{i} column density vs. Doppler parameter}
\end{figure}
...
\uncover<1->{\begin{itemize}
  \uncover<2->{\item 16 \ion{O}{vi} absorbers} 
  \uncover<3->{\item 26 components}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=9cm]{Figures/Z_vs_nH.png}
  \vspace*{-1mm}
  \caption{Ionisation modelling solutions ($\text{n}_\text{H}, Z$) for all 26 components.}
\end{figure} 
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=9cm]{Figures/NHi_vs_nH.png}
  \vspace*{-1mm}
...
\begin{frame}[noframenumbering]{\textbf{\ion{O}{vi}} cases}

\begin{figure}[!htbp]
  \centering
  \includegraphics[width=9cm]{Figures/Ovi_cases.png}
  \vspace*{-1mm}
...
\uncover<1->{\begin{itemize}
  \uncover<2->{\item Voigt profile fitting : 6} 
  \uncover<3->{\item Ionisation modelling : 12}
  \uncover<4->{\item Exploring the survey results} 
  \uncover<5->{\item \textit{Finally}, calculating $\Omega_b (BLA)$}
\end{itemize}
}
...
\begin{frame}{\huge{{\textbf{Summary}}}}
  ...
  \uncover<1->{\begin{itemize}
    \item Voigt profile fitting : 22 absorbers - 231 Voigt profiles
    \item Ionisation modelling : 16 absorbers - 26 components 
    \item \ion{O}{vi} couldn't be explained with photoionization models   
    \item BLA survey towards completion
  \end{itemize}
  }
