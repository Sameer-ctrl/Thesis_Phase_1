...
param_line_Shull=['HI1    -10 0 14 1 15.91 0.03',
                  'HI2     0 0 19 1 15.95 0.02', 
                  'HI3     4 1 46 2 14.18 0.05',
                  'OVI     0 1 36 2 13.81 0.01',
                  'CIV     3 3 20 4 13.14 0.05',
                  'CIII   -4 1 7 1 15.33 0.53'
                  'CII1   -10 0 6 1 13.73 0.16',
                  'CII2    0  0  5 3 13.41 0.12',
                  'NIII   1 2 16 3 14.01 0.05',
                  'NII1  -10 0 6 3 13.45 0.20',
                  'NII2   0 0 14 4 13.51 0.15',
                  'SiIV  -10 1 3 1 12.68 0.27']
